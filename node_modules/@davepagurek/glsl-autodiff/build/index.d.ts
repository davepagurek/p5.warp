import { ADSettings, Input, Param, Op, Value, ADBase } from './base';
...
export declare type AD = GetType<typeof ExtendedAD>;
export declare const gen: (cb: (ad: AD) => void, settings?: Partial<ADSettings>) => string;
export {};
