import { Op, ADBase, Param, Input, ADConstructor } from './base';
...
export declare class VecParamElementRef extends Param {
    prop: string;
    name: string;
    constructor(ad: ADBase, prop: string, vec: VecOp);
...
export declare abstract class ScalarWithVecDependencies extends Op {
    get vecDependsOn(): VecOp[];
    size(): number;
}
export declare class OffsetJacobian extends WithVecDependencies {
    constructor(ad: any, ...args: any[]);
    size(): number;
    private position;
    private offset;
    glslType(): string;
    ...
    dot(vec3: VectorOp): Mat3Dot;
}
export declare class Mat3Dot extends VectorOp {
    size(): number;
    private mat3;
    private vec3;
    definition(): string;
...
export declare class VecParam extends VectorOp {
    ...
    x(): any;
    y(): VecParamElementRef;
    z(): VecParamElementRef;
    w(): VecParamElementRef;
    private getElems;
    definition(): string;
    derivative(param: Param): string;
    isConst(param?: Param): boolean;
...
export declare function WithVecBase<T extends ADConstructor>(Base: T): {
    new (...args: any[]): {
        ...
        settings: import("./base").ADSettings;
    };
} & T;
